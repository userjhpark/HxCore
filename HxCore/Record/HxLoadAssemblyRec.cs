...
namespace HxCore
{
    public struct HxLoadAssemblyRec
    {
        ...
        public string LoadAssemblyTitle
        {
            get
            {
                if (LoadAssembly != null)
                {
                    AssemblyTitleAttribute assemblyTitleAttribute = (AssemblyTitleAttribute)LoadAssembly.GetCustomAttributes(typeof(AssemblyTitleAttribute), false)?[0];
        ...
        public HxLoadAssemblyRec(string inputFileName = null)
        {
    ...
    public class HxLoadAssembly
    {
        ...
        */
        ...
        public HxLoadAssembly(string inputFileName = null)
        {
            string strFileName = inputFileName;
            AppFriendlyName = null;
            AppProcessName = null;
            ...
            if(strFileName.IsNullOrWhiteSpaceEx() == true || HxFile.FileExists(strFileName) != true)
            {
                strFileName = AppEnvFullName;
            }
            strFileName = HxFile.GetFileFullPath(strFileName);
            if (strFileName.IsNullOrWhiteSpaceEx() != true && HxFile.FileExists(strFileName))
            {
