...
namespace HxCore.Win.PDFXE
{
    partial class HxPDFXE
    {
        ...
        public static string GetRegistryOptStr(string rootPath, string valName, string keyName = "", string defVal = "")
        {
        ...
        public static int GetRegistryOptInt(string rootPath, string valName, string keyName = "", int defVal = 0)
        {
            //string path = "Software\\Tracker Software\\PDFEditorSDKExamples";
            string path = rootPath;
            if (keyName != "")
        ...
        public static void SetRegistryOptStr(string rootPath, string valName, string val, string keyName = "")
        {
            //string path = "Software\\Tracker Software\\PDFEditorSDKExamples";
            string path = rootPath;
            if (keyName != "")
        ...
        public static void SetRegistryOptInt(string rootPath, string valName, int val, string keyName = "")
        {
            //string path = "Software\\Tracker Software\\PDFEditorSDKExamples";
            string path = rootPath;
            if (keyName != "")
        ...
        public static void SetRegistryOptBool(string rootPath, string valName, bool val, string keyName = "")
        {
            //string path = "Software\\Tracker Software\\PDFEditorSDKExamples";
            string path = rootPath;
            if (keyName != "")
